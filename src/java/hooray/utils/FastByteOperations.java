...
//  modifications copyright (c) 2023 Finn Völkel
...
public class FastByteOperations
{
    ...
    {
        return BestHolder.BEST.compare(b1.array(), s1, l1, b2, s2, l2);
    }

    public static int compareUnsigned(byte[] b1 ,int s1, int l1, ByteBuffer b2, int s2, int l2)
    {
        return BestHolder.BEST.compare(b1, s1, l1, b2.array(), s2, l2);
    }
    ...
    @SuppressWarnings({"unused", "deprecation"} ) // used via reflection
